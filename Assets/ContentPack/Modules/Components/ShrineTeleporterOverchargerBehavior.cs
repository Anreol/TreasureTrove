...
namespace TreasureTrove.Components
{
    ...
    internal class ShrineTeleporterOverchargerBehavior : NetworkBehaviour
    {
        ...
        public void AddShrineStack(Interactor interactor)
        {
            ...
            if (statSheet != null)
            {
                statSheet.PushStatValue(TreasureTrove.Misc.CostAndStatExtras.totalTeleporterOverchargerUsed, 1UL);
                statSheet.PushStatValue(TreasureTrove.Misc.CostAndStatExtras.highestTeleporterOverchargerUsed, statSheet.GetStatValueULong(TreasureTrove.Misc.CostAndStatExtras.totalTeleporterOverchargerUsed));
            }
