...
namespace TreasureTrove
{
    public static class Assets
    {
        ...
        internal static string assemblyDir => Path.GetDirectoryName(TreasureTroveUnityPlugin.pluginInfo.Location);
        ...
        internal static string mainAssetBundleName = "assetTrove";
        ...
        internal static void MapMaterials(AssetBundle assetBundle)
        {
            ...
            for (int i = 0; i < assetBundleMaterials.Length; i++)
            {
                ...
                if (assetBundleMaterials[i].shader.name.Contains("Stubbed"))
                {
                    ...
                    {
                        TTLog.LogE($"Failed to swap shader of material {assetBundleMaterials[i]}: {ex}", true);
                    }
                }
            }
        }
