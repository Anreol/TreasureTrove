...
{
	[CreateAssetMenu(menuName = "TreasureTrove/SerializableContentPackExpanded")]
	class SerializableContentPackExpanded : SerializableContentPack
    {
		...
		public EntitlementDef[] entitlementDefs = Array.Empty<EntitlementDef>(); //I'll check if the user has Shovel Knight in its steam library, and that will be funny.
