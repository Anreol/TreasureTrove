    ...
    internal class CombatDirectorInjector
    {
        ...
        public static void Init()
        {
            if (USE_UNIQUE_DCCS)
            {
                ...
                frozenWallExtraEntry.requiredExpansions = new ExpansionDef[] { TTContent.Expansions.TurboExpansion };
                ...
                wispGraveyardExtraEntry.requiredExpansions = new ExpansionDef[] { TTContent.Expansions.TurboExpansion };
                ...
                dampCaveExtraEntry.requiredExpansions = new ExpansionDef[] { TTContent.Expansions.TurboExpansion };
        ...
        {
            TTLog.LogW("Refreshing director cards in " + CombatDirector.instancesList.Count + " directors.");
            foreach (CombatDirector director in CombatDirector.instancesList)
            {
                TTLog.LogW("Trying to refresh cards... fallback to stage monsters is " + director.fallBackToStageMonsterCards);
                ...
                {
                    TTLog.LogW("Falling back to stage monster cards... is _monsterCards null" + director._monsterCards == null);
                    ...
                    {
                        TTLog.LogW("TE Combat Director Cards refreshed.");
