...
using Equipment = TreasureTrove.Equipments.Equipment;
using Item = TreasureTrove.Items.Item;
...
namespace TreasureTrove
{
    public class InitPickups
    {
        ...
        public static void HookInit()
        {
            ...
            TTLog.LogI("Subscribing to delegates related to Items and Equipments.", true);
        ...
        {
            TTLog.LogD($"Getting Legacy Items found inside {Assembly.GetExecutingAssembly()}...", true);
        ...
        {
            TTLog.LogD($"Getting the Equipments found inside {Assembly.GetExecutingAssembly()}...");
            Assembly.GetExecutingAssembly().GetTypes()
