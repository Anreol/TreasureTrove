...
namespace TreasureTrove.Items
{
    ...
    public class StandBonusBodyBehavior : BaseItemBodyBehavior, IStatBarProvider
    {
        ...
        {
            return TTContent.Items.StandBonus;
        }
        ...
        public StatBarData GetStatBarData()
        {
            ...
            return new StatBarData
            {
                ...
                {
                    titleColor = ColorCatalog.GetColor(TTContent.Items.StandBonus.darkColorIndex),
                    titleToken = TTContent.Items.StandBonus.nameToken,
