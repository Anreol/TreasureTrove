...
namespace TreasureTrove.Items
{
    internal class GetDamageFromHurtVictimBodyBehavior : BaseItemBodyBehavior, IStatItemBehavior, IStatBarProvider
    {
        ...
        {
            return TTContent.Items.SoulDevourer;
        }
        ...
        {
            if (arg1.attackerBody.inventory.GetItemCount(TTContent.Items.SoulDevourer) > 0)
            {
        ...
        public StatBarData GetStatBarData()
        {
            ...
            return new StatBarData
            {
                ...
                {
                    titleColor = ColorCatalog.GetColor(ItemTierCatalog.GetItemTierDef(TTContent.Items.SoulDevourer.tier).darkColorIndex),
                    titleToken = TTContent.Items.SoulDevourer.nameToken,
